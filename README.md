...
1. [GPU Learning Resources](https://github.com/mikeroyal/GPU-Guide#gpu-learning-resources) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

2. [Electric charge, field, and potential](https://github.com/mikeroyal/GPU-Guide#electric-charge-field-and-potential) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
3. [Circuits](https://github.com/mikeroyal/GPU-Guide#Circuits) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Ohm's law and circuits with resistors: Circuits
   * Circuits with capacitors: Circuits

4. [Magnetic forces, magnetic fields, and Faraday's law](https://github.com/mikeroyal/GPU-Guide#magnetic-forces-magnetic-fields-and-Faradays-law) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
5. [Electromagnetic waves and interference](https://github.com/mikeroyal/GPU-Guide#electromagnetic-waves-and-interference) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Introduction to electromagnetic waves: Electromagnetic waves and interference
   * Interference of electromagnetic waves

6. [Geometric optics](https://github.com/mikeroyal/GPU-Guide#Geometric-optics) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Reflection and refraction: Geometric optics
   * Mirrors: Geometric optics
   * Lenses

7. [Linear Algebra](https://github.com/mikeroyal/GPU-Guide#Linear-Algebra) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

8. [Virtualization](https://github.com/mikeroyal/GPU-Guide#virtualization) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

9. [Parallel Computing](https://github.com/mikeroyal/GPU-Guide#Parallel-Computing) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

10. [OpenCL Development](https://github.com/mikeroyal/GPU-Guide#opencl-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

11. [CUDA Development](https://github.com/mikeroyal/GPU-Guide#cuda-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

12. [Algorithms](https://github.com/mikeroyal/GPU-Guide#algorithms) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

13. [Machine Learning](https://github.com/mikeroyal/GPU-Guide#machine-learning) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

14. [Deep Learning Development](https://github.com/mikeroyal/GPU-Guide#Deep-Learning-Development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

15. [Computer Vision Development](https://github.com/mikeroyal/GPU-Guide#computer-vision-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

16. [Gaming](https://github.com/mikeroyal/GPU-Guide#gaming) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

17. [Game Development](https://github.com/mikeroyal/GPU-Guide#game-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

18. [OpenGL Development](https://github.com/mikeroyal/GPU-Guide#opengl-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

19. [Vulkan Development](https://github.com/mikeroyal/GPU-Guide#vulkan-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

20. [DirectX Development](https://github.com/mikeroyal/GPU-Guide#directx-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

21. [Professional Audio/Video Development](https://github.com/mikeroyal/GPU-Guide#professional-audiovideo-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

22. [3D Graphics & Design](https://github.com/mikeroyal/GPU-Guide#3d-graphics-and-design) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

23. [Apple Silicon](https://github.com/mikeroyal/GPU-Guide#Apple-Silicon) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

24. [Core ML Development](https://github.com/mikeroyal/GPU-Guide#core-ml-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

25. [Metal Development](https://github.com/mikeroyal/GPU-Guide#Metal-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

26. [MATLAB Development](https://github.com/mikeroyal/GPU-Guide#matlab-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

27. [C/C++ Development](https://github.com/mikeroyal/GPU-Guide#cc-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

28. [Python Development](https://github.com/mikeroyal/GPU-Guide#python-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

29. [R Development](https://github.com/mikeroyal/GPU-Guide#r-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

30. [Julia Development](https://github.com/mikeroyal/GPU-Guide#julia-development) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

# Awesome GPU Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/GPU-Guide#table-of-contents) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
[Caffe](https://github.com/BVLC/caffe) ⭐ 34,572 | 🐛 1,527 | 🌐 C++ | 📅 2024-07-31 is a deep learning framework made with expression, speed, and modularity in mind. It is developed by Berkeley AI Research (BAIR)/The Berkeley Vision and Learning Center (BVLC) and community contributors.
...
[Media Source Extensions (MSE)](https://www.w3.org/TR/media-source/) is a [W3C specification](https://github.com/w3c/media-source) ⭐ 286 | 🐛 115 | 🌐 HTML | 📅 2026-08-07 that allows JavaScript to send byte streams to media codecs within Web browsers that support HTML5 video and audio. Also, this allows the implementation of client-side prefetching and buffering code for streaming media entirely in JavaScript.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,440 | 🐛 1,007 | 🌐 C++ | 📅 2026-08-06 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,068 | 🐛 59 | 🌐 C++ | 📅 2026-07-17 is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures. This codepath is optimized for drawing deforming subdivs with static topology at interactive framerates. The resulting limit surface matches Pixar's Renderman to numerical precision.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,416 | 🐛 47 | 🌐 CSS | 📅 2026-08-02 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,174 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,238 | 🐛 245 | 🌐 CSS | 📅 2026-08-06
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,355 | 🐛 1,162 | 🌐 CMake | 📅 2026-08-13 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,477 | 🐛 48 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,106 | 🐛 139 | 🌐 Python | 📅 2026-07-29 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,583 | 🐛 319 | 🌐 Python | 📅 2026-08-12 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,417 | 🐛 328 | 🌐 Python | 📅 2024-12-17 is a command line HTTP client that makes CLI interaction with web services as easy as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-12 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,284 | 🐛 842 | 🌐 JavaScript | 📅 2026-08-09.
...
[Debugger.jl](https://github.com/JuliaDebug/Debugger.jl) ⭐ 513 | 🐛 33 | 🌐 Julia | 📅 2026-07-26 is the Julia debuggin tool.
...
[AWS.jl](https://github.com/JuliaCloud/AWS.jl) ⭐ 166 | 🐛 106 | 🌐 Julia | 📅 2026-08-12 is a Julia interface for [Amazon Web Services](https://aws.amazon.com/).
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,201 | 🐛 111 | 🌐 Julia | 📅 2026-07-29 is a univariate and multivariate optimization in Julia.

[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 337 | 🐛 46 | 🌐 Julia | 📅 2026-08-11 is a package that allows you to call R functions from Julia.
...
[MXNet.jl](https://github.com/dmlc/MXNet.jl) ⭐ 370 | 🐛 45 | 📅 2019-07-19 is the Apache MXNet Julia package. MXNet.jl brings flexible and efficient GPU computing and state-of-art deep learning to Julia.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,197 | 🐛 474 | 🌐 Julia | 📅 2026-08-03 is a Julia package for probability distributions and associated functions.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/GPU-Guide/pulls) ⭐ 316 | 🐛 0 | 🌐 Shell | 📅 2022-02-01.
