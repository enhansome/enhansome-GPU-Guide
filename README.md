...
[Numba](https://github.com/numba/numba) ⭐ 11,123 | 🐛 1,804 | 🌐 Python | 📅 2026-08-15 is an open source, NumPy-aware optimizing compiler for Python sponsored by Anaconda, Inc. It uses the LLVM compiler project to generate machine code from Python syntax. Numba can compile a large subset of numerically-focused Python, including many NumPy functions. Additionally, Numba has support for automatic parallelization of loops, generation of GPU-accelerated code, and creation of ufuncs and C callbacks.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,448 | 🐛 1,008 | 🌐 C++ | 📅 2026-08-06 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,070 | 🐛 59 | 🌐 C++ | 📅 2026-08-17 is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures. This codepath is optimized for drawing deforming subdivs with static topology at interactive framerates. The resulting limit surface matches Pixar's Renderman to numerical precision.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,482 | 🐛 44 | 🌐 Python | 📅 2026-08-15 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,175 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[C++ Client Libraries for Google Cloud Services](https://github.com/googleapis/google-cloud-cpp) ⭐ 658 | 🐛 206 | 🌐 C++ | 📅 2026-08-18
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,107 | 🐛 139 | 🌐 Python | 📅 2026-07-29 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,589 | 🐛 327 | 🌐 Python | 📅 2026-08-17 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,293 | 🐛 850 | 🌐 JavaScript | 📅 2026-08-17.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,202 | 🐛 114 | 🌐 Julia | 📅 2026-08-18 is a univariate and multivariate optimization in Julia.
