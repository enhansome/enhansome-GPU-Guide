...
1. [GPU Learning Resources](https://github.com/mikeroyal/GPU-Guide#gpu-learning-resources) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

2. [Electric charge, field, and potential](https://github.com/mikeroyal/GPU-Guide#electric-charge-field-and-potential) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
3. [Circuits](https://github.com/mikeroyal/GPU-Guide#Circuits) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Ohm's law and circuits with resistors: Circuits
   * Circuits with capacitors: Circuits

4. [Magnetic forces, magnetic fields, and Faraday's law](https://github.com/mikeroyal/GPU-Guide#magnetic-forces-magnetic-fields-and-Faradays-law) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
5. [Electromagnetic waves and interference](https://github.com/mikeroyal/GPU-Guide#electromagnetic-waves-and-interference) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Introduction to electromagnetic waves: Electromagnetic waves and interference
   * Interference of electromagnetic waves

6. [Geometric optics](https://github.com/mikeroyal/GPU-Guide#Geometric-optics) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Reflection and refraction: Geometric optics
   * Mirrors: Geometric optics
   * Lenses

7. [Linear Algebra](https://github.com/mikeroyal/GPU-Guide#Linear-Algebra) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

8. [Virtualization](https://github.com/mikeroyal/GPU-Guide#virtualization) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

9. [Parallel Computing](https://github.com/mikeroyal/GPU-Guide#Parallel-Computing) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

10. [OpenCL Development](https://github.com/mikeroyal/GPU-Guide#opencl-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

11. [CUDA Development](https://github.com/mikeroyal/GPU-Guide#cuda-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

12. [Algorithms](https://github.com/mikeroyal/GPU-Guide#algorithms) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

13. [Machine Learning](https://github.com/mikeroyal/GPU-Guide#machine-learning) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

14. [Deep Learning Development](https://github.com/mikeroyal/GPU-Guide#Deep-Learning-Development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

15. [Computer Vision Development](https://github.com/mikeroyal/GPU-Guide#computer-vision-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

16. [Gaming](https://github.com/mikeroyal/GPU-Guide#gaming) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

17. [Game Development](https://github.com/mikeroyal/GPU-Guide#game-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

18. [OpenGL Development](https://github.com/mikeroyal/GPU-Guide#opengl-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

19. [Vulkan Development](https://github.com/mikeroyal/GPU-Guide#vulkan-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

20. [DirectX Development](https://github.com/mikeroyal/GPU-Guide#directx-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

21. [Professional Audio/Video Development](https://github.com/mikeroyal/GPU-Guide#professional-audiovideo-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

22. [3D Graphics & Design](https://github.com/mikeroyal/GPU-Guide#3d-graphics-and-design) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

23. [Apple Silicon](https://github.com/mikeroyal/GPU-Guide#Apple-Silicon) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

24. [Core ML Development](https://github.com/mikeroyal/GPU-Guide#core-ml-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

25. [Metal Development](https://github.com/mikeroyal/GPU-Guide#Metal-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

26. [MATLAB Development](https://github.com/mikeroyal/GPU-Guide#matlab-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

27. [C/C++ Development](https://github.com/mikeroyal/GPU-Guide#cc-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

28. [Python Development](https://github.com/mikeroyal/GPU-Guide#python-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

29. [R Development](https://github.com/mikeroyal/GPU-Guide#r-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

30. [Julia Development](https://github.com/mikeroyal/GPU-Guide#julia-development) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

# Awesome GPU Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/GPU-Guide#table-of-contents) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,200 | 🐛 234 | 🌐 Rust | 📅 2026-09-08 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,309 | 🐛 701 | 🌐 Python | 📅 2026-09-08 for high performance training and inference.

[XGBoost](https://xgboost.readthedocs.io/) is an optimized distributed gradient boosting library designed to be highly efficient, flexible and portable. It implements machine learning algorithms under the Gradient Boosting framework. XGBoost provides a parallel tree boosting (also known as GBDT, GBM) that solve many data science problems in a fast and accurate way. It supports distributed training on multiple machines, including AWS, GCE, Azure, and Yarn clusters. Also, it can be integrated with Flink, Spark and other cloud dataflow systems.

[cuML](https://github.com/rapidsai/cuml) ⭐ 5,271 | 🐛 815 | 🌐 Python | 📅 2026-09-08 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[HLSL to SPIR-V Feature Mapping Manual](https://github.com/microsoft/DirectXShaderCompiler/blob/master/docs/SPIR-V.rst) ⭐ 3,646 | 🐛 773 | 🌐 C++ | 📅 2026-09-08
...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 18,035 | 🐛 256 | 🌐 C++ | 📅 2026-09-08 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,946 | 🐛 347 | 🌐 C | 📅 2026-09-08 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,127 | 🐛 1,226 | 🌐 C++ | 📅 2026-09-07 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
...
[Media Source Extensions (MSE)](https://www.w3.org/TR/media-source/) is a [W3C specification](https://github.com/w3c/media-source) ⭐ 287 | 🐛 116 | 🌐 HTML | 📅 2026-08-07 that allows JavaScript to send byte streams to media codecs within Web browsers that support HTML5 video and audio. Also, this allows the implementation of client-side prefetching and buffering code for streaming media entirely in JavaScript.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,480 | 🐛 1,007 | 🌐 C++ | 📅 2026-08-27 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.

[OpenTimelineIO](https://github.com/PixarAnimationStudios/OpenTimelineIO) ⭐ 1,976 | 🐛 206 | 🌐 C++ | 📅 2026-08-07 is an interchange format and API for editorial cut information. OTIO is not a container format for media, rather it contains information about the order and length of cuts and references to external media. OTIO includes both a file format and an API for manipulating that format. It also includes a plugin architecture for writing adapters to convert from/to existing editorial timeline formats. It also implements a dependency- less library for dealing strictly with time, opentime.

[OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,071 | 🐛 58 | 🌐 C++ | 📅 2026-08-19 is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures. This codepath is optimized for drawing deforming subdivs with static topology at interactive framerates. The resulting limit surface matches Pixar's Renderman to numerical precision.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,839 | 🐛 41 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Gthree](https://github.com/alexlarsson/gthree) ⭐ 89 | 🐛 29 | 🌐 C | 📅 2026-08-09 is a GObject/Gtk+ port of three.js.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,186 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,450 | 🐛 1,219 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,118 | 🐛 23 | 🌐 Python | 📅 2026-09-04 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,625 | 🐛 344 | 🌐 Python | 📅 2026-09-04 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-08 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,319 | 🐛 767 | 🌐 JavaScript | 📅 2026-09-04.
...
[DataFrames Tutorial using Jupyter Notebooks](https://github.com/bkamins/Julia-DataFrames-Tutorial/) ⭐ 538 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2023-02-13
...
[Debugger.jl](https://github.com/JuliaDebug/Debugger.jl) ⭐ 513 | 🐛 35 | 🌐 Julia | 📅 2026-09-01 is the Julia debuggin tool.
...
[IJulia.jl](https://github.com/JuliaLang/IJulia.jl) ⭐ 2,902 | 🐛 36 | 🌐 Julia | 📅 2026-06-23 is the Julia kernel for Jupyter.
...
[Nanosoldier.jl](https://github.com/JuliaCI/Nanosoldier.jl) ⭐ 31 | 🐛 31 | 🌐 Julia | 📅 2026-09-07 is a package for running JuliaCI services on MIT's Nanosoldier cluster.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,204 | 🐛 112 | 🌐 Julia | 📅 2026-09-02 is a univariate and multivariate optimization in Julia.

[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 338 | 🐛 49 | 🌐 Julia | 📅 2026-09-08 is a package that allows you to call R functions from Julia.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,198 | 🐛 478 | 🌐 Julia | 📅 2026-09-08 is a Julia package for probability distributions and associated functions.
...
[IRTools.jl](https://github.com/FluxML/IRTools.jl) ⭐ 113 | 🐛 41 | 🌐 Julia | 📅 2026-08-10 is a simple and flexible IR format, expressive enough to work with both lowered and typed Julia code, as well as external IRs.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/GPU-Guide/pulls) ⭐ 325 | 🐛 0 | 🌐 Shell | 📅 2022-02-01.
