...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 18,073 | 🐛 258 | 🌐 C++ | 📅 2026-09-10 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,951 | 🐛 346 | 🌐 C | 📅 2026-09-14 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,489 | 🐛 1,005 | 🌐 C++ | 📅 2026-09-08 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,932 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Azure SDK for C++](https://github.com/Azure/azure-sdk-for-cpp) ⭐ 205 | 🐛 178 | 🌐 C++ | 📅 2026-09-12
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,121 | 🐛 28 | 🌐 Python | 📅 2026-09-14 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,641 | 🐛 335 | 🌐 Python | 📅 2026-09-11 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,328 | 🐛 773 | 🌐 JavaScript | 📅 2026-09-14.
