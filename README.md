...
[SPIRV-Reflect](https://github.com/KhronosGroup/SPIRV-Reflect) ⭐ 864 | 🐛 53 | 🌐 C | 📅 2026-08-10 is a lightweight library that provides a C/C++ reflection API for SPIR-V shader bytecode in Vulkan applications.
...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 17,841 | 🐛 254 | 🌐 C++ | 📅 2026-08-12 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,442 | 🐛 1,006 | 🌐 C++ | 📅 2026-08-06 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,431 | 🐛 46 | 🌐 CSS | 📅 2026-08-02 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,288 | 🐛 846 | 🌐 JavaScript | 📅 2026-08-13.
