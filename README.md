...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 17,989 | 🐛 258 | 🌐 C++ | 📅 2026-09-03 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,936 | 🐛 340 | 🌐 C | 📅 2026-09-03 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,038 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-03 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,471 | 🐛 1,006 | 🌐 C++ | 📅 2026-08-27 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,780 | 🐛 45 | 🌐 Python | 📅 2026-09-02 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,432 | 🐛 1,182 | 🌐 CMake | 📅 2026-09-03 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,117 | 🐛 34 | 🌐 Python | 📅 2026-09-02 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,616 | 🐛 329 | 🌐 Python | 📅 2026-09-02 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-02 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,316 | 🐛 773 | 🌐 JavaScript | 📅 2026-09-03.
