...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,357 | 🐛 342 | 🌐 Java | 📅 2026-09-01 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.
...
[HLSL to SPIR-V Feature Mapping Manual](https://github.com/microsoft/DirectXShaderCompiler/blob/master/docs/SPIR-V.rst) ⭐ 3,640 | 🐛 778 | 🌐 C++ | 📅 2026-09-02
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,464 | 🐛 1,005 | 🌐 C++ | 📅 2026-08-27 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,753 | 🐛 45 | 🌐 Python | 📅 2026-09-02 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,118 | 🐛 34 | 🌐 Python | 📅 2026-09-02 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,613 | 🐛 328 | 🌐 Python | 📅 2026-09-02 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,316 | 🐛 768 | 🌐 JavaScript | 📅 2026-09-01.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,204 | 🐛 115 | 🌐 Julia | 📅 2026-09-02 is a univariate and multivariate optimization in Julia.
