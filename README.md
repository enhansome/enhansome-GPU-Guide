...
1. [GPU Learning Resources](https://github.com/mikeroyal/GPU-Guide#gpu-learning-resources) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

2. [Electric charge, field, and potential](https://github.com/mikeroyal/GPU-Guide#electric-charge-field-and-potential) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
3. [Circuits](https://github.com/mikeroyal/GPU-Guide#Circuits) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Ohm's law and circuits with resistors: Circuits
   * Circuits with capacitors: Circuits

4. [Magnetic forces, magnetic fields, and Faraday's law](https://github.com/mikeroyal/GPU-Guide#magnetic-forces-magnetic-fields-and-Faradays-law) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
5. [Electromagnetic waves and interference](https://github.com/mikeroyal/GPU-Guide#electromagnetic-waves-and-interference) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Introduction to electromagnetic waves: Electromagnetic waves and interference
   * Interference of electromagnetic waves

6. [Geometric optics](https://github.com/mikeroyal/GPU-Guide#Geometric-optics) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Reflection and refraction: Geometric optics
   * Mirrors: Geometric optics
   * Lenses

7. [Linear Algebra](https://github.com/mikeroyal/GPU-Guide#Linear-Algebra) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

8. [Virtualization](https://github.com/mikeroyal/GPU-Guide#virtualization) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

9. [Parallel Computing](https://github.com/mikeroyal/GPU-Guide#Parallel-Computing) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

10. [OpenCL Development](https://github.com/mikeroyal/GPU-Guide#opencl-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

11. [CUDA Development](https://github.com/mikeroyal/GPU-Guide#cuda-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

12. [Algorithms](https://github.com/mikeroyal/GPU-Guide#algorithms) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

13. [Machine Learning](https://github.com/mikeroyal/GPU-Guide#machine-learning) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

14. [Deep Learning Development](https://github.com/mikeroyal/GPU-Guide#Deep-Learning-Development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

15. [Computer Vision Development](https://github.com/mikeroyal/GPU-Guide#computer-vision-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

16. [Gaming](https://github.com/mikeroyal/GPU-Guide#gaming) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

17. [Game Development](https://github.com/mikeroyal/GPU-Guide#game-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

18. [OpenGL Development](https://github.com/mikeroyal/GPU-Guide#opengl-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

19. [Vulkan Development](https://github.com/mikeroyal/GPU-Guide#vulkan-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

20. [DirectX Development](https://github.com/mikeroyal/GPU-Guide#directx-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

21. [Professional Audio/Video Development](https://github.com/mikeroyal/GPU-Guide#professional-audiovideo-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

22. [3D Graphics & Design](https://github.com/mikeroyal/GPU-Guide#3d-graphics-and-design) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

23. [Apple Silicon](https://github.com/mikeroyal/GPU-Guide#Apple-Silicon) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

24. [Core ML Development](https://github.com/mikeroyal/GPU-Guide#core-ml-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

25. [Metal Development](https://github.com/mikeroyal/GPU-Guide#Metal-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

26. [MATLAB Development](https://github.com/mikeroyal/GPU-Guide#matlab-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

27. [C/C++ Development](https://github.com/mikeroyal/GPU-Guide#cc-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

28. [Python Development](https://github.com/mikeroyal/GPU-Guide#python-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

29. [R Development](https://github.com/mikeroyal/GPU-Guide#r-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

30. [Julia Development](https://github.com/mikeroyal/GPU-Guide#julia-development) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

# Awesome GPU Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/GPU-Guide#table-of-contents) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
[VirtManager](https://github.com/virt-manager/virt-manager) ⭐ 3,254 | 🐛 158 | 🌐 Python | 📅 2026-09-04 is a graphical tool for managing virtual machines via libvirt. Most usage is with QEMU/KVM virtual machines, but Xen and libvirt LXC containers are well supported. Common operations for any libvirt driver should work.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,250 | 🐛 222 | 🌐 Rust | 📅 2026-09-22 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Numba](https://github.com/numba/numba) ⭐ 11,157 | 🐛 1,798 | 🌐 Python | 📅 2026-09-21 is an open source, NumPy-aware optimizing compiler for Python sponsored by Anaconda, Inc. It uses the LLVM compiler project to generate machine code from Python syntax. Numba can compile a large subset of numerically-focused Python, including many NumPy functions. Additionally, Numba has support for automatic parallelization of loops, generation of GPU-accelerated code, and creation of ufuncs and C callbacks.

[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,339 | 🐛 684 | 🌐 Python | 📅 2026-09-21 for high performance training and inference.

[XGBoost](https://xgboost.readthedocs.io/) is an optimized distributed gradient boosting library designed to be highly efficient, flexible and portable. It implements machine learning algorithms under the Gradient Boosting framework. XGBoost provides a parallel tree boosting (also known as GBDT, GBM) that solve many data science problems in a fast and accurate way. It supports distributed training on multiple machines, including AWS, GCE, Azure, and Yarn clusters. Also, it can be integrated with Flink, Spark and other cloud dataflow systems.

[cuML](https://github.com/rapidsai/cuml) ⭐ 5,287 | 🐛 797 | 🌐 Python | 📅 2026-09-22 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[clSPARSE](https://github.com/clMathLibraries/clSPARSE) ⭐ 177 | 🐛 46 | 🌐 C++ | 📅 2020-02-21 is a software library containing Sparse functions written in OpenCL.

[clRNG](https://github.com/clMathLibraries/clRNG) ⭐ 137 | 🐛 16 | 🌐 C | 📅 2021-11-19 is an OpenCL based software library containing random number generation functions.
...
[cocos2d-x](https://github.com/cocos2d/cocos2d-x) ⭐ 19,189 | 🐛 1,604 | 🌐 C++ | 📅 2025-05-09 is a multi-platform framework for building 2d games, interactive books, demos and other graphical applications. It is based on cocos2d-iphone, but instead of using Objective-C, it uses C++. It works on iOS, Android, macOS, Windows and Linux.

[MonoGame](https://github.com/MonoGame/MonoGame) ⭐ 14,440 | 🐛 763 | 🌐 C# | 📅 2026-09-22 is a framework for creating powerful cross-platform games. The spiritual successor to XNA with thousands of titles shipped across desktop, mobile, and console platforms. MonoGame is a fully managed .NET open source game framework without any black boxes.
...
[HLSL to SPIR-V Feature Mapping Manual](https://github.com/microsoft/DirectXShaderCompiler/blob/master/docs/SPIR-V.rst) ⭐ 3,653 | 🐛 771 | 🌐 C++ | 📅 2026-09-22
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,964 | 🐛 315 | 🌐 C | 📅 2026-09-22 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,311 | 🐛 1,226 | 🌐 C++ | 📅 2026-09-22 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
...
[Vulkan.jl](https://github.com/JuliaGPU/Vulkan.jl) ⭐ 128 | 🐛 0 | 🌐 Julia | 📅 2026-09-21 is a lightweight wrapper around the Vulkan graphics and compute library. It exposes abstractions over the underlying C interface, primarily geared towards developers looking for a more natural way to work with Vulkan with minimal overhead.
...
[Media Source Extensions (MSE)](https://www.w3.org/TR/media-source/) is a [W3C specification](https://github.com/w3c/media-source) ⭐ 286 | 🐛 116 | 🌐 HTML | 📅 2026-08-07 that allows JavaScript to send byte streams to media codecs within Web browsers that support HTML5 video and audio. Also, this allows the implementation of client-side prefetching and buffering code for streaming media entirely in JavaScript.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,500 | 🐛 1,004 | 🌐 C++ | 📅 2026-09-18 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.

[OpenTimelineIO](https://github.com/PixarAnimationStudios/OpenTimelineIO) ⭐ 1,986 | 🐛 213 | 🌐 C++ | 📅 2026-09-21 is an interchange format and API for editorial cut information. OTIO is not a container format for media, rather it contains information about the order and length of cuts and references to external media. OTIO includes both a file format and an API for manipulating that format. It also includes a plugin architecture for writing adapters to convert from/to existing editorial timeline formats. It also implements a dependency- less library for dealing strictly with time, opentime.

[OpenSubdiv](https://github.com/PixarAnimationStudios/OpenSubdiv) ⭐ 3,073 | 🐛 58 | 🌐 C++ | 📅 2026-09-19 is a set of open source libraries that implement high performance subdivision surface (subdiv) evaluation on massively parallel CPU and GPU architectures. This codepath is optimized for drawing deforming subdivs with static topology at interactive framerates. The resulting limit surface matches Pixar's Renderman to numerical precision.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 18,095 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Gthree](https://github.com/alexlarsson/gthree) ⭐ 90 | 🐛 29 | 🌐 C | 📅 2026-08-09 is a GObject/Gtk+ port of three.js.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,193 | 🐛 130 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,328 | 🐛 247 | 🌐 CSS | 📅 2026-08-06
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,480 | 🐛 1,117 | 🌐 CMake | 📅 2026-09-22 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,621 | 🐛 56 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,122 | 🐛 22 | 🌐 Python | 📅 2026-09-21 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,654 | 🐛 343 | 🌐 Python | 📅 2026-09-22 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[spaCy](https://github.com/explosion/spaCy) ⭐ 33,914 | 🐛 245 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
...
[R Debugger](https://marketplace.visualstudio.com/items?itemName=RDebugger.r-debugger) is an extension that adds debugging capabilities for the R programming language to Visual Studio Code and depends on the R package [vscDebugger (documentation)](https://github.com/ManuelHentschel/vscDebugger) ⭐ 107 | 🐛 12 | 🌐 R | 📅 2026-08-12.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-22 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,338 | 🐛 783 | 🌐 JavaScript | 📅 2026-09-22.
...
[Debugger.jl](https://github.com/JuliaDebug/Debugger.jl) ⭐ 514 | 🐛 35 | 🌐 Julia | 📅 2026-09-01 is the Julia debuggin tool.
...
[IJulia.jl](https://github.com/JuliaLang/IJulia.jl) ⭐ 2,906 | 🐛 36 | 🌐 Julia | 📅 2026-06-23 is the Julia kernel for Jupyter.
...
[Nanosoldier.jl](https://github.com/JuliaCI/Nanosoldier.jl) ⭐ 31 | 🐛 31 | 🌐 Julia | 📅 2026-09-21 is a package for running JuliaCI services on MIT's Nanosoldier cluster.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,205 | 🐛 114 | 🌐 Julia | 📅 2026-09-17 is a univariate and multivariate optimization in Julia.

[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 338 | 🐛 48 | 🌐 Julia | 📅 2026-09-18 is a package that allows you to call R functions from Julia.

[JavaCall.jl](http://juliainterop.github.io/JavaCall.jl) is a package that allows you to call Java functions from Julia.

[PyCall.jl](https://github.com/JuliaPy/PyCall.jl) ⭐ 1,512 | 🐛 295 | 🌐 Julia | 📅 2026-08-06 is a package that allows you to call Python functions from Julia.

[MXNet.jl](https://github.com/dmlc/MXNet.jl) ⭐ 369 | 🐛 45 | 📅 2019-07-19 is the Apache MXNet Julia package. MXNet.jl brings flexible and efficient GPU computing and state-of-art deep learning to Julia.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,200 | 🐛 481 | 🌐 Julia | 📅 2026-09-16 is a Julia package for probability distributions and associated functions.
...
[IRTools.jl](https://github.com/FluxML/IRTools.jl) ⭐ 113 | 🐛 42 | 🌐 Julia | 📅 2026-09-21 is a simple and flexible IR format, expressive enough to work with both lowered and typed Julia code, as well as external IRs.

[Cassette.jl](https://github.com/jrevels/Cassette.jl) ⭐ 383 | 🐛 46 | 🌐 Julia | 📅 2025-02-10 is a Julia package that provides a mechanism for dynamically injecting code transformation passes into Julia’s just-in-time (JIT) compilation cycle, enabling post hoc analysis and modification of "Cassette-unaware" Julia programs without requiring manual source annotation or refactoring of the target code.

## Contribute

* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/GPU-Guide/pulls) ⭐ 329 | 🐛 0 | 🌐 Shell | 📅 2022-02-01.
