...
1. [GPU Learning Resources](https://github.com/mikeroyal/GPU-Guide#gpu-learning-resources) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

2. [Electric charge, field, and potential](https://github.com/mikeroyal/GPU-Guide#electric-charge-field-and-potential) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
3. [Circuits](https://github.com/mikeroyal/GPU-Guide#Circuits) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Ohm's law and circuits with resistors: Circuits
   * Circuits with capacitors: Circuits

4. [Magnetic forces, magnetic fields, and Faraday's law](https://github.com/mikeroyal/GPU-Guide#magnetic-forces-magnetic-fields-and-Faradays-law) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
5. [Electromagnetic waves and interference](https://github.com/mikeroyal/GPU-Guide#electromagnetic-waves-and-interference) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Introduction to electromagnetic waves: Electromagnetic waves and interference
   * Interference of electromagnetic waves

6. [Geometric optics](https://github.com/mikeroyal/GPU-Guide#Geometric-optics) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

   * Reflection and refraction: Geometric optics
   * Mirrors: Geometric optics
   * Lenses

7. [Linear Algebra](https://github.com/mikeroyal/GPU-Guide#Linear-Algebra) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

8. [Virtualization](https://github.com/mikeroyal/GPU-Guide#virtualization) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

9. [Parallel Computing](https://github.com/mikeroyal/GPU-Guide#Parallel-Computing) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

10. [OpenCL Development](https://github.com/mikeroyal/GPU-Guide#opencl-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

11. [CUDA Development](https://github.com/mikeroyal/GPU-Guide#cuda-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

12. [Algorithms](https://github.com/mikeroyal/GPU-Guide#algorithms) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

13. [Machine Learning](https://github.com/mikeroyal/GPU-Guide#machine-learning) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

14. [Deep Learning Development](https://github.com/mikeroyal/GPU-Guide#Deep-Learning-Development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

15. [Computer Vision Development](https://github.com/mikeroyal/GPU-Guide#computer-vision-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

16. [Gaming](https://github.com/mikeroyal/GPU-Guide#gaming) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

17. [Game Development](https://github.com/mikeroyal/GPU-Guide#game-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

18. [OpenGL Development](https://github.com/mikeroyal/GPU-Guide#opengl-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

19. [Vulkan Development](https://github.com/mikeroyal/GPU-Guide#vulkan-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

20. [DirectX Development](https://github.com/mikeroyal/GPU-Guide#directx-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

21. [Professional Audio/Video Development](https://github.com/mikeroyal/GPU-Guide#professional-audiovideo-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

22. [3D Graphics & Design](https://github.com/mikeroyal/GPU-Guide#3d-graphics-and-design) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

23. [Apple Silicon](https://github.com/mikeroyal/GPU-Guide#Apple-Silicon) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

24. [Core ML Development](https://github.com/mikeroyal/GPU-Guide#core-ml-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

25. [Metal Development](https://github.com/mikeroyal/GPU-Guide#Metal-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

26. [MATLAB Development](https://github.com/mikeroyal/GPU-Guide#matlab-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

27. [C/C++ Development](https://github.com/mikeroyal/GPU-Guide#cc-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

28. [Python Development](https://github.com/mikeroyal/GPU-Guide#python-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

29. [R Development](https://github.com/mikeroyal/GPU-Guide#r-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

30. [Julia Development](https://github.com/mikeroyal/GPU-Guide#julia-development) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01

# Awesome GPU Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/GPU-Guide#table-of-contents) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,146 | 🐛 226 | 🌐 Rust | 📅 2026-08-26 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,276 | 🐛 709 | 🌐 Python | 📅 2026-08-25 for high performance training and inference.
...
[LibGDX](https://github.com/libgdx/libgdx) ⭐ 25,338 | 🐛 338 | 🌐 Java | 📅 2026-08-25 is a cross-platform Java game development framework based on OpenGL (ES) that works on Windows, Linux, Mac OS X, Android, your WebGL enabled browser and iOS.
...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 17,922 | 🐛 254 | 🌐 C++ | 📅 2026-08-26 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,928 | 🐛 346 | 🌐 C | 📅 2026-08-26 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,456 | 🐛 1,009 | 🌐 C++ | 📅 2026-08-25 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,630 | 🐛 46 | 🌐 Python | 📅 2026-08-15 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Gthree](https://github.com/alexlarsson/gthree) ⭐ 88 | 🐛 29 | 🌐 C | 📅 2026-08-09 is a GObject/Gtk+ port of three.js.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,183 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,273 | 🐛 246 | 🌐 CSS | 📅 2026-08-06
...
[C++ Client Libraries for Google Cloud Services](https://github.com/googleapis/google-cloud-cpp) ⭐ 659 | 🐛 206 | 🌐 C++ | 📅 2026-08-26
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,523 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,114 | 🐛 91 | 🌐 Python | 📅 2026-08-26 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,596 | 🐛 326 | 🌐 Python | 📅 2026-08-26 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,101 | 🐛 3 | 🌐 Python | 📅 2026-08-24 is an easy to use, scriptable and scalable performance testing tool.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-08-26 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,300 | 🐛 823 | 🌐 JavaScript | 📅 2026-08-25.
...
[Debugger.jl](https://github.com/JuliaDebug/Debugger.jl) ⭐ 514 | 🐛 35 | 🌐 Julia | 📅 2026-08-14 is the Julia debuggin tool.
...
[Nanosoldier.jl](https://github.com/JuliaCI/Nanosoldier.jl) ⭐ 31 | 🐛 31 | 🌐 Julia | 📅 2026-08-24 is a package for running JuliaCI services on MIT's Nanosoldier cluster.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,203 | 🐛 113 | 🌐 Julia | 📅 2026-08-20 is a univariate and multivariate optimization in Julia.

[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 338 | 🐛 47 | 🌐 Julia | 📅 2026-08-25 is a package that allows you to call R functions from Julia.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,197 | 🐛 474 | 🌐 Julia | 📅 2026-08-20 is a Julia package for probability distributions and associated functions.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/GPU-Guide/pulls) ⭐ 322 | 🐛 0 | 🌐 Shell | 📅 2022-02-01.
