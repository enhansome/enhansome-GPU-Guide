...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,277 | 🐛 812 | 🌐 Python | 📅 2026-09-15 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,952 | 🐛 319 | 🌐 C | 📅 2026-09-15 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,198 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-14 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
...
[Universal Scene Description](https://github.com/PixarAnimationStudios/USD) ⭐ 7,490 | 🐛 1,002 | 🌐 C++ | 📅 2026-09-14 is an efficient, scalable system for authoring, reading, and streaming time-sampled scene description for interchange between graphics applications.
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,965 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,463 | 🐛 1,126 | 🌐 CMake | 📅 2026-09-15 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,120 | 🐛 18 | 🌐 Python | 📅 2026-09-14 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,644 | 🐛 337 | 🌐 Python | 📅 2026-09-15 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,514 | 🐛 338 | 🌐 Python | 📅 2024-12-17 is a command line HTTP client that makes CLI interaction with web services as easy as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-15 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,333 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-14.
...
[AWS.jl](https://github.com/JuliaCloud/AWS.jl) ⭐ 166 | 🐛 112 | 🌐 Julia | 📅 2026-08-13 is a Julia interface for [Amazon Web Services](https://aws.amazon.com/).
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,199 | 🐛 480 | 🌐 Julia | 📅 2026-09-15 is a Julia package for probability distributions and associated functions.
