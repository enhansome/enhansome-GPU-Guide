...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,210 | 🐛 221 | 🌐 Rust | 📅 2026-09-10 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,312 | 🐛 697 | 🌐 Python | 📅 2026-09-10 for high performance training and inference.
...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 18,043 | 🐛 256 | 🌐 C++ | 📅 2026-09-09 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,947 | 🐛 346 | 🌐 C | 📅 2026-09-10 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,138 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-09 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,858 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,187 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[C++ Client Libraries for Google Cloud Services](https://github.com/googleapis/google-cloud-cpp) ⭐ 660 | 🐛 206 | 🌐 C++ | 📅 2026-09-10
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,118 | 🐛 24 | 🌐 Python | 📅 2026-09-09 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,631 | 🐛 344 | 🌐 Python | 📅 2026-09-09 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-09 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,323 | 🐛 770 | 🌐 JavaScript | 📅 2026-09-10.
...
[IJulia.jl](https://github.com/JuliaLang/IJulia.jl) ⭐ 2,903 | 🐛 36 | 🌐 Julia | 📅 2026-06-23 is the Julia kernel for Jupyter.
...
[Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) ⭐ 1,205 | 🐛 112 | 🌐 Julia | 📅 2026-09-02 is a univariate and multivariate optimization in Julia.

[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 338 | 🐛 45 | 🌐 Julia | 📅 2026-09-08 is a package that allows you to call R functions from Julia.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,199 | 🐛 478 | 🌐 Julia | 📅 2026-09-08 is a Julia package for probability distributions and associated functions.
