...
[Numba](https://github.com/numba/numba) ⭐ 11,155 | 🐛 1,794 | 🌐 Python | 📅 2026-09-16 is an open source, NumPy-aware optimizing compiler for Python sponsored by Anaconda, Inc. It uses the LLVM compiler project to generate machine code from Python syntax. Numba can compile a large subset of numerically-focused Python, including many NumPy functions. Additionally, Numba has support for automatic parallelization of loops, generation of GPU-accelerated code, and creation of ufuncs and C callbacks.
...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,281 | 🐛 800 | 🌐 Python | 📅 2026-09-17 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[Vulkan Samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,375 | 🐛 70 | 🌐 C++ | 📅 2026-09-10
...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 18,091 | 🐛 255 | 🌐 C++ | 📅 2026-09-15 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,954 | 🐛 305 | 🌐 C | 📅 2026-09-16 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,227 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-17 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
...
[PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) ⭐ 17,995 | 🐛 42 | 🌐 Python | 📅 2026-09-05 is a simple Patch for [GIMP 2.10+](https://www.gimp.org/) to help all Adobe Photoshop Users feel at home.
...
[Goxel](https://github.com/guillaumechereau/goxel) ⭐ 3,191 | 🐛 129 | 🌐 C++ | 📅 2026-07-26 is a free and Open Source 3D Voxel Editor.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,607 | 🐛 53 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
...
[Pylance](https://github.com/microsoft/pylance-release) ⭐ 2,119 | 🐛 20 | 🌐 Python | 📅 2026-09-16 is an extension that works alongside Python in Visual Studio Code to provide performant language support. Under the hood, Pylance is powered by Pyright, Microsoft's static type checking tool.

[Pyright](https://github.com/Microsoft/pyright) ⭐ 15,646 | 🐛 339 | 🌐 Python | 📅 2026-09-17 is a fast type checker meant for large Python source bases. It can run in a “watch” mode and performs fast incremental updates when files are modified.
...
[Luigi](https://github.com/spotify/luigi) ⭐ 18,775 | 🐛 178 | 🌐 Python | 📅 2026-07-18 is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built-in.
...
[Rplugin](https://github.com/JetBrains/Rplugin) ⭐ 70 | 🐛 2 | 🌐 Kotlin | 📅 2026-09-16 is R Language supported plugin for the IntelliJ IDE.

[Plotly](https://plotly-r.com/) is an R package for creating interactive web graphics via the open source JavaScript graphing library [plotly.js](https://github.com/plotly/plotly.js) ⭐ 18,336 | 🐛 775 | 🌐 JavaScript | 📅 2026-09-16.
...
[RCall.jl](https://github.com/JuliaInterop/RCall.jl) ⭐ 338 | 🐛 47 | 🌐 Julia | 📅 2026-09-15 is a package that allows you to call R functions from Julia.
...
[Distributions.jl](https://github.com/JuliaStats/Distributions.jl) ⭐ 1,199 | 🐛 480 | 🌐 Julia | 📅 2026-09-16 is a Julia package for probability distributions and associated functions.
